...
export default function EditClass({ errors, kelas }) {

    const [ kelasName, setKelasName] = useState(kelas.kelas_name);
    ...
    const submitKelas = async (e)=>{
        ...
        formData.append('kelas_name', kelasName);


        Inertia.put(`/class/${kelas.id}`, {
                    ...
                    <div className="grid grid-cols-4">
                        <div className="col-span-3 ml-5 mt-2">
                            <label htmlFor="first_name"
                                   className="block text-sm mb-1 font-semibold text-gray-500 dark:text-white">Nama Kelas</label>
                            ...
                            {validation.kelas_name && (
                                <div className="bg-white text-center py-1 lg:px-4">
                                    <div className="p-2 bg-yellow-800 items-center text-yellow-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
                                        ...
                                        <span className="font-semibold mr-2 text-left flex-auto">{validation.kelas_name[0]}</span>
