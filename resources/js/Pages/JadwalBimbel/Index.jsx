                                ...
                                jadwal_bimbels.map((sesi, index) =>(
                                    <>
                                        {sesi.tentors.length>1 && (
                                            <>
                                                <tr key={index}>
                                                    <td rowSpan={sesi.tentors.length}> {sesi.sesi_name} </td>
                                                    <td > {sesi.tentors[index].tentors_name} </td>
...

                                        {
                                            sesi.tentors.length ==1 &&(
                                                <>
                                                    {
                                                        sesi.tentors[0].jadwal_bimbels.length > 1 && (
                                                            <>
                                                                <tr>
                                                                    <td rowSpan={sesi.tentors[0].jadwal_bimbels.length}>{sesi.sesi_name} </td>
                                                                    <td rowSpan={sesi.tentors[0].jadwal_bimbels.length}>{sesi.tentors[0].tentors_name} </td>
                                                                    <td>{sesi.tentors[0].jadwal_bimbels[0].siswa.siswa_name} </td>
                                                                    <td className="text-center grid grid-cols-2">
                                                                        edit {sesi.tentors[0].jadwal_bimbels.length}
                                                                    </td>
                                                                </tr>
                                                                {
