...
export default function MapelIndex({ mapels, session }) {

    const deleteMapel = async (id)=>{
        Inertia.delete(`/mapels/${id}`)
    ...
    return (
        <SidebarNew>
            <div >
                ...
                <Link href="/mapels/create" className="btn text-white gap-x-2 shadow-lg btn-success btn-md ml-8">
