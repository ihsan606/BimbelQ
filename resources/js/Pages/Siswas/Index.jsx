...
export default function SiswaIndex({ siswas, session }) {
    ...
    return (
        <SidebarNew>
            <div >
                ...
                <Link href="/siswas/create" className="btn text-white gap-x-2 shadow-lg btn-success btn-md ml-8">
                    ...
                    <div className="card-body">
                        <table className="table table-auto bg-white shadow-lg rounded-lg">
                            ...
                            <tr>
                                ...
                                <th className="bg-[#E1F4FF] text-[#1597E5]" scope="col">EMAIL</th>
