...
export default function TarifIndex({ tarifs, session }) {
    ...
    return (
        <SidebarNew>
            <div >
                ...
                <Link href="/tarifs/create" className="btn text-white gap-x-2 shadow-lg btn-success btn-md ml-8">
                ...
                <div className=" border-0 rounded shadow-sm">
                    <div className="card-body">
                        <table className="table table-auto bg-white shadow-lg rounded-lg">
                            ...
                            <tr>
                                <th className="bg-[#E1F4FF] text-[#1597E5] font-medium" scope="col">PROGRAM</th>
                                <th className="bg-[#E1F4FF] text-[#1597E5] font-medium" scope="col">KELAS</th>
                                <th className="bg-[#E1F4FF] text-[#1597E5] font-medium" scope="col">TARIF BELAJAR</th>
                                <th className="bg-[#E1F4FF] text-[#1597E5] font-medium" scope="col">TARIF MENTOR</th>

                                <th className="bg-[#E1F4FF] text-[#1597E5] w-28 text-center font-medium" scope="col">ACTIONS</th>
                            </tr>
                            </thead>
                            <tbody>
                            { tarifs.map((tarif, index) => (
                                <tr className={"bg-white"} key={ index }>
                                    ...
                                    <td className="text-center grid grid-cols-2 bg-white border border-1 bg-white border-gray-200">
                                        <Link href={`/tarifs/${tarif.id}/edit`}>
