                    ...
                    <div className="px-8">
                        ...
                        <ul className="mt-1">
                            <li
                                className={
                                    currentPath === "home"
                                        ? "flex w-full h-full justify-between text-gray-300 cursor-pointer items-center mb-2 bg-gray-500 rounded-lg px-2 py-2"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span className="text-sm ml-2">Sesi</span>
                                </Link>
                            </li>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span className="text-sm ml-2">Tentor</span>
                                </Link>
                            </li>
                            <li
                                className={
