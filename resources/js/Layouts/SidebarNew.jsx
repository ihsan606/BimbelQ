                ...
                <div className="flex flex-no-wrap">
                    <div  className="w-64 absolute sm:relative bg-gray-800 shadow md:h-screen flex-col justify-between hidden sm:flex">
                        <div className="px-8">
                            ...
                            <ul className="mt-12">
                                <li className={currentPath === "home"?"flex w-full h-full justify-between text-gray-300 cursor-pointer items-center mb-2 bg-gray-500 rounded-lg px-2 py-2":"flex w-full justify-between text-gray-300 cursor-pointer items-center mb-2 px-2 py-2 hover:bg-gray-500 hover:rounded-lg"}>
                                    <Link href="/home"  className="flex items-center focus:outline-none hover:text-white w-full focus:ring-2 focus:ring-white">
                                ...
                                <li className={currentPath === "class"?"flex w-full justify-between text-gray-300 cursor-pointer items-center mb-2 bg-gray-500 rounded-lg px-2 py-2":"flex w-full justify-between text-gray-300 cursor-pointer items-center mb-2 px-2 py-2 hover:bg-gray-500 hover:rounded-lg"}>
                                    <Link href="/class"  className="flex items-center focus:outline-none hover:text-white w-full focus:ring-2 focus:ring-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-grid" width="18" height="18" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z"></path>
                                            <rect x="4" y="4" width="6" height="6" rx="1"></rect>
                                            <rect x="14" y="4" width="6" height="6" rx="1"></rect>
                                        ...
                                        <span className="text-sm ml-2">Kelas</span>
                                    </Link>
                                </li>
                                <li className={currentPath === "mapels"?"flex w-full justify-between text-gray-300 cursor-pointer items-center mb-2 bg-gray-500 rounded-lg px-2 py-2":"flex w-full justify-between text-gray-300 cursor-pointer items-center mb-2 px-2 py-2 hover:bg-gray-500 hover:rounded-lg"}>
                                    <Link href="/mapels"  className="flex items-center focus:outline-none hover:text-white w-full focus:ring-2 focus:ring-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-grid" width="18" height="18" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z"></path>
                                            <rect x="4" y="4" width="6" height="6" rx="1"></rect>
                                            <rect x="14" y="4" width="6" height="6" rx="1"></rect>
                                        ...
                                        <span className="text-sm ml-2">Mapel</span>
                                    </Link>
                                </li>

                                <li className={currentPath === "tarifs"?"flex w-full justify-between text-gray-300 cursor-pointer items-center mb-2 bg-gray-500 rounded-lg px-2 py-2":"flex w-full justify-between text-gray-300 cursor-pointer items-center mb-2 px-2 py-2 hover:bg-gray-500 hover:rounded-lg"}>
                                    <Link href="/tarifs"  className="flex items-center focus:outline-none hover:text-white w-full focus:ring-2 focus:ring-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-grid" width="18" height="18" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z"></path>
                                            <rect x="4" y="4" width="6" height="6" rx="1"></rect>
                                            <rect x="14" y="4" width="6" height="6" rx="1"></rect>
                                        ...
                                        <span className="text-sm ml-2">Tarif</span>
                                    </Link>
                                </li>

                                <button onClick={logoutHandler} className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center">
                                    <a  className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5 5H11C11.55 5 12 4.55 12 4C12 3.45 11.55 3 11 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H11C11.55 21 12 20.55 12 20C12 19.45 11.55 19 11 19H5V5Z" fill="#9BA1AC"/>
                                            <path d="M20.65 11.65L17.86 8.86004C17.7905 8.78859 17.7012 8.73952 17.6036 8.71911C17.506 8.69869 17.4045 8.70787 17.3121 8.74545C17.2198 8.78304 17.1408 8.84733 17.0851 8.93009C17.0295 9.01286 16.9999 9.11033 17 9.21004V11H10C9.45 11 9 11.45 9 12C9 12.55 9.45 13 10 13H17V14.79C17 15.24 17.54 15.46 17.85 15.14L20.64 12.35C20.84 12.16 20.84 11.84 20.65 11.65Z" fill="#9BA1AC"/>
                                        </svg>
                            ...
                            <ul className="mt-12">
                                ...
                                <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center">
                                    <a  className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                        ...
                                        <span className="text-sm ml-2">Setting dfds</span>
                                    </a>
                                </li>
                            </ul>
                            <div className="flex justify-center mt-48 mb-4 w-full">
                    ...
                    <div className="container px-10 bg-white mx-auto py-10 h-full md:w-4/5 w-11/12">
                        <div className="w-full h-full px-3 flex-wrap py-3 h-full  rounded border-dashed border-2 border-gray-300">
                            {children}
                        </div>
                    </div>
                </div>
